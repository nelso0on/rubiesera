...
public class MCreatorRubydimension extends ruby_mod.ModElement {

	public static int DIMID = 4;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("ruby_mod:rubydimension")
	public static final Item block = null;
	@GameRegistry.ObjectHolder("ruby_mod:rubydimension_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;

	public MCreatorRubydimension(ruby_mod instance) {
		super(instance);
		instance.blocks.add(() -> new BlockCustomPortal());
		instance.items.add(() -> new ItemBlock(portal).setRegistryName(portal.getRegistryName()));
		instance.items.add(() -> new ModTrigger().setUnlocalizedName("rubydimension").setRegistryName("rubydimension"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension rubydimension is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("rubydimension", "_rubydimension", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("ruby_mod:rubydimension", "inventory"));
	}
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(0.835294117647, 0.133333333333, 0.133333333333);
		}
					...
					for (int k1 = -2; k1 <= 2; ++k1) {
						for (int l1 = -1; l1 < 3; ++l1) {
							...
							this.world.setBlockState(new BlockPos(i2, j2, k2),
									flag ? MCreatorStonewithruby.block.getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							this.world.setBlockState(new BlockPos(i6 + (l7 - 1) * l6 + j7 * i3, k2 + k8, k6 + (l7 - 1) * i3 - j7 * l6), (k8 < 0)
									? MCreatorStonewithruby.block.getDefaultState()
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						this.world.setBlockState(new BlockPos(i6 + (l8 - 1) * l6, k2 + l9, k6 + (l8 - 1) * i3),
								(l8 == 0 || l8 == 3 || l9 == -1 || l9 == 3) ? MCreatorStonewithruby.block.getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		...
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("rubydimension_portal");
			setRegistryName("rubydimension_portal");
			setLightLevel(0.05F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != MCreatorStonewithruby.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == MCreatorStonewithruby.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != MCreatorStonewithruby.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != MCreatorStonewithruby.block
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("ruby_mod:rubybiome")),};
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		protected static final IBlockState STONE = MCreatorRubydirt.block.getDefaultState();
		protected static final IBlockState GRAVEL = MCreatorRubydirt.block.getDefaultState();

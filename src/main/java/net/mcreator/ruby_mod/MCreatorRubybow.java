...
public class MCreatorRubybow extends ruby_mod.ModElement {

	@GameRegistry.ObjectHolder("ruby_mod:rubybow")
	public static final Item block = null;
	public static final int ENTITYID = 2;

	public MCreatorRubybow(ruby_mod instance) {
		super(instance);
		instance.items.add(() -> new RangedItem());
		instance.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("ruby_mod", "entitybulletrubybow"), ENTITYID).name("entitybulletrubybow").tracker(64, 1, true).build());
	}

	@Override
	@SideOnly(Side.CLIENT)
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("ruby_mod:rubybow", "inventory"));
	}
	...
	public static class RangedItem extends Item {
		...
		public RangedItem() {
			...
			maxStackSize = 1;
			setFull3D();
			setUnlocalizedName("rubybow");
			setRegistryName("rubybow");
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, EntityLivingBase entityLivingBase, int timeLeft) {
			if (!world.isRemote && entityLivingBase instanceof EntityPlayerMP) {
				...
				int slotID = entity.inventory.getSlotFor(new ItemStack(Items.ARROW, (int) (1)));
				if (flag || slotID != -1) {
					float f = 1.5F;

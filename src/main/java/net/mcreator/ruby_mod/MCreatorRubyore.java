...
public class MCreatorRubyore extends ruby_mod.ModElement {

	@GameRegistry.ObjectHolder("ruby_mod:rubyore")
	public static final Block block = null;

	public MCreatorRubyore(ruby_mod instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("ruby_mod:rubyore", "inventory"));
	}
